...
// // Возможно, потому что сначала мы выполняем команду querySelector('ul'), она важнее и выполняется раньше. А 
// // addEventListener находится в режиме ожидания, пока не совершится какое-либо действие.
